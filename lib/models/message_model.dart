...
List<Message> chats = [
  ...
  Message(
    sender: olivia,
    time: '4:30 PM',
    text: 'If he doesn\’t like you, this is all a moo-point.',
    isLiked: false,
    unread: true,
  ),
  Message(
  ...
  Message(
    sender: sophia,
    time: '2:30 PM',
    text: 'I\’m sorry, it was a one-time thing. I was very drunk, and it was someone else’s subconscious.',
    isLiked: false,
    unread: true,
  ),
  Message(
